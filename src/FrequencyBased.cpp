...
void FrequencyBased::appendFrequencies(std::map<std::string, int>& master, std::map<std::string, int>& toAppend) {
...
void FrequencyBased::readData(std::string directory) {
  ...
  std::map<std::string, int> methods1 { {"typeid", 5}, {"getX", 4}, {"getY", 6}, {"pathClear", 1} };
  std::map<std::string, int> methods2 { {"typeid", 2}, {"getX", 1}, {"isCheck", 1}, {"Coordinate", 1} };
